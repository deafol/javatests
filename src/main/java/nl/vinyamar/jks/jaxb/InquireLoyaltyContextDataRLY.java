 ...
 *         &lt;element name="Party" type="{http://www.ing.com/lchc}Party2" minOccurs="0"/>
...
@XmlRootElement(name = "InquireLoyaltyContextDataRLY", namespace = "http://www.ing.com/lch/ilcd")
public class InquireLoyaltyContextDataRLY {

    @XmlElement(name = "ReturnCode", required = true)
    protected String returnCode;
    @XmlElement(name = "Party")
    protected Party2 party;
     ...
     *     
     */
    public void setParty(Party2 value) {
        this.party = value;
    }
